...
import { registerSchema, loginSchema, refreshSchema } from '@presentation/validators/auth.validators';
...
const authLimiter = rateLimit({
  ...
  legacyHeaders: false,
  message: { success: false, error: { code: 'TOO_MANY_REQUESTS', message: 'Trop de tentatives, réessaie plus tard' } },
});
...
// Le logout est géré côté client (suppression des tokens stockés) car les JWT sont stateless ici.
